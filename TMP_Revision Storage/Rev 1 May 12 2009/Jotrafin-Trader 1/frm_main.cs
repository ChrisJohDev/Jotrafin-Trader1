...
namespace D4M.FINANCE.JOTRAFIN
{
	public partial class frm_main : Form
	{
		...
		private VTAPI.AccountsClass api_accounts;	// Accounts collection.
		...
		private void Echo(string msg, string head)
		{
			DateTime dt = DateTime.Now;
	...
	// Put inside if statment when compiling real version.
		...
		private void UnAssignEvents()
		{
			...
			{
				MessageBox.Show("Can't Un-assign events. Error: " + e.Message,"Dropping API Events Error!",MessageBoxButtons.OK,MessageBoxIcon.Information);
			}
		}
		private bool Login()
		{
